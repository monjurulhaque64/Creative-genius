  ...
  return (
    <div className="container mx-auto mt-[40px] md:mt-[98px]">
      ...
      <div className="mx-auto text-center h-[80px] md:h-[100px] ">
        ...
        <p className="font font-[400] w-[300px] md:w-[650px] text-center mx-auto text-[16px] text-white mt-[20px]">
      ...
      <div className="w-full h-[400px] lg:h-[600px] md:h-[500px] relative">
        <div className="md:flex justify-between">
          <div className="lg:ml-[100px] ml-8  lg:w-[726px] w-[250px] lg:pt-[250px] mt-[70px] ">
