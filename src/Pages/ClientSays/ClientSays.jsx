  ...
  return (
    <div className="container mx-auto mt-[40px] md:mt-[72px]">
      ...
      <div className="join mt-10 flex gap-2 justify-center mr-4  md:mr-10  mb-[198px]">
        <button
          className={`join-item pagination btn text-white bg-[#28303ad4] hover:bg-[#28303ad4] ${currentPage === 1 ? "btn-disabled" : ""}`}
        ...
        <button className="join-item pagination btn rounded-md text-white bg-[#28303ad4]   hover:bg-[#28303ad4]"
        style={{ border: '1px solid #404040' }}
        >0{currentPage}</button>
        <button
          className={`join-item btn pagination text-white bg-[#28303ad4]    hover:bg-[#28303ad4] ${
