...
const Fwq = () => {
  ...
  const divClass = isAccordionOpen && "bg-[#FF0000] border-0";
  const divClass1 = isAccordionOpen1 && "bg-[#FF0000] border-0";
  const divClass2 = isAccordionOpen2 && "bg-[#FF0000] border-0";
  const divClass3 = isAccordionOpen3 && "bg-[#FF0000] border-0";
  const divClass4 = isAccordionOpen4 && "bg-[#FF0000] border-0";
  const divClass5 = isAccordionOpen5 && "bg-[#FF0000] border-0";
