      ...
      <Accordion>
          ...
          <AccordionItem
            ...
            header={
              <div className="flex items-center justify-between md:gap-[2rem] gap-[1px]">
                <h1 className='justify-start font text-[18px] md:text-[24px]  font-[400]'>What is the target of digital marketing for your company?</h1>
        ...
        <div className='flex items-center md:gap-6  gap-3 md:w-2/3    faq-card md:mb-10'>
          ...
          >
            ...
            <p className='  text-[15px] md:text-[16px]     mt-2 text-white heading font-[400] text-justify'> Typically, an average project will take in the region of three –
        ...
        <div className='flex items-center md:gap-6  gap-3 md:w-2/3    faq-card md:mb-10'>
          ...
          >
            <p className='  text-[15px] md:text-[16px]     mt-2 text-white heading font-[400] text-justify'>  It's a great idea to make a content strategy framework first. Take
        ...
        <div className='flex items-center md:gap-6  gap-3 md:w-2/3    faq-card '>
          ...
          <AccordionItem className="collapse border-2 mt-6  p-3    md:text-[24px]  text-[20px] bg-[rgba(34, 34, 34, 0.80)] shadow-xl lg:w-[604px]  mt-6 rounded-md border-[1px] border-[#8a8a8a]"
              ...
              header={
              <div className="flex items-center justify-between  gap-3">
                <h1 className='justify-start font text-[18px] md:text-[24px]  font-[400]'>What are the qualities of a successful team?</h1>
