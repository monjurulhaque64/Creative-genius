    ...
    <div className="container mx-auto">
      <div className="flex justify-between p-[15px] lg:pl-[66px] lg:pr-[66px] client-spring-containt lg:w-[1220px] mx-auto md:h-173px lg:h-[180px] h-[95px]   ">
        <div className="   md:mt-4">
          <h1 className="flex text-[20px] md:text-[40px] heading font-[600]  justify-center text-center text-[#3C4FF8]">
            <Number n={103} />
        ...
        <div className="   md:mt-4">
          <h1 className="flex text-[20px] md:text-[40px] heading font-[600] text-center justify-center text-[#3C4FF8]">
            <Number n={12} />
            <animated.span>{" +"}</animated.span>
          </h1>
          <h3 className="heading text-[15px] md:text-[20px] font-[600] text-center text-white lg:mt-[7px]">
