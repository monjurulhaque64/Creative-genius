         ...
         <SwiperSlide>
          <div className="w-full h-[800px]  bannerimg1">
            <div className="lg:ml-[50px] ml-8  lg:w-[726px] w-[350px] md:w-[70%]  lg:pt-[200px] pt-[50px] ">
              ...
              <p className="font-[Poppins] w-[290px] md:w-[350px] text-[17px] text-white text-justify font-medium mt-2">
          ...
          <div className="w-full  h-[650px] md:h-[800px] bannerimg2 relative">
            ...
            <div className="flex justify-between container2">
              <div className="lg:ml-[50px] ml-4  lg:w-[726px] md:w-[80%] w-[350px] lg:pt-[250px] s-left-side pt-[30px] ">
                <h1 className="lg:text-[64px] title text-[34px] font-[Saira Stencil One] font-bold text-white">
                  Learning <span className="titleBg">Campus</span>
                </h1>
                <p className="font-[Poppins] text-[17px]  w-[290px] md:w-[350px] text-white text-justify font-medium mt-2">
          ...
          <div className="w-full h-[800px] bannerimg3 relative">
            <div className="flex md:justify-between container3">
              <div className="lg:ml-[50px] ml-8  lg:w-[726px] w-[350px] lg:pt-[250px] pt-[50px]">
                ...
                <h1 className="lg:text-[64px] title text-[34px] font-[Saira Stencil One] font-[700] text-white z-10 ">
                  Learning Campus
                </h1>
                <p className="font-[Poppins] text-[17px] w-[290px] md:w-[350px] text-white text-justify font-medium my-4">
       ...
       <SwiperSlide>
          <div className="w-full md:h-[800px] bannerimg4 relative">
            <div className="flex justify-between container4">
              <div className="absolute lg:left-[15rem] lg:top-[12rem] logo1"><svg xmlns="http://www.w3.org/2000/svg" width="38" height="37" viewBox="0 0 38 37" fill="none">
              ...
              <div className="lg:ml-[50px] ml-8  lg:w-[726px] w-[350px] lg:pt-[250px] pt-[50px] left-side">
                ...
                <p className="font-[Poppins] text-[17px] text-white text-justify font-medium my-4">
