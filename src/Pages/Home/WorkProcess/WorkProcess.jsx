...
const WorkProcess = () => {
  ...
  return (
    <div className="container mx-auto mt-[72px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 mx-auto gap-12 justify-center items-center max-w-full">
        <div className="flex mx-auto">
          <div className="w-[250px] ">
            <h1 className=" w-[89px] h-[89px] bg-[#ff0000] rounded-full text-center flex justify-center items-center font-[Roboto] font-[700] text-white text-[30px] mx-auto">
              1
            </h1>
            <h1 className="text-center font-[Poppins] font-[400] text-[32px] text-black">
              Strategy
            </h1>
            <p className="text-center font-[Poppins] font-[400] text-[18px] text-black mt-4">
